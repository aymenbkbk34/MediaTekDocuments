    ...
    public class Access
    {
        ...
        private Access()
        {
            ...
            try
            {
                ...
                string mdp = System.Configuration.ConfigurationManager.AppSettings["mdp"];
                authenticationString = login + ":" + mdp;
                api = ApiRest.GetInstance(uriApi, authenticationString);
                log("Connexion à l'API réussie");
...
/// Retourne la liste des suivis disponibles
/// </summary>
/// <returns>Liste de Suivi ou null</returns>
public List<Suivi> GetAllSuivis()
        ...
        /// <summary>
        /// Retourne la liste des commandes d'un livre ou DVD
        /// </summary>
        ...
        /// </summary>
        public bool DeleteCommandeDocument(string id)
        {
            try
            {
                List<CommandeDocument> liste = TraitementRecup<CommandeDocument>("DELETE", "commandedocument/" + id, null);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        public bool DeleteAbonnement(string id)
        {
            try
            {
                List<Abonnement> liste = TraitementRecup<Abonnement>("DELETE", "abonnement/" + id, null);
                return (liste != null);
            }
            catch (Exception ex)
            {
        ...
        /// <summary>
        /// Retourne un utilisateur par login et mdp
        /// </summary>
        public Utilisateur GetUtilisateur(string login, string mdp)
        {
            String jsonChamps = JsonConvert.SerializeObject(new { login = login, mdp = mdp });
